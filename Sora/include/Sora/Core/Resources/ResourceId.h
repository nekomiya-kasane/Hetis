...
namespace Sora {
    ...
    namespace Resources {
         ...
         * @c res://... URI, must not contain Windows separators, and must not carry query or fragment components.
         * Runtime request parameters belong to higher-level open calls, not to package identity hashes.
         */
