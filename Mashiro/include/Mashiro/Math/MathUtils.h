...
namespace Mashiro::Math {
    ...
    /**
     * @name Generic vector functions (any HomogeneousVec)
     *
     * `Dot`, `NormSq`, `Normalize`, `Distance`, `DistanceSq`, `Lerp`, `Reflect`,
     * `Project`, `Reject` are defined generically over InnerProductSpace / VectorSpace
     * concepts in Algebra.h and live in this same namespace.
     * @{
     */
    ...
    /** @brief Which vector norm to compute: L1 (sum |x|), L2 (Euclidean), Linf (max |x|). */
