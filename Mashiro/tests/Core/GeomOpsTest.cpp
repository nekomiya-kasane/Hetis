...
TEST_CASE("Translation moves a Ray's origin but leaves its direction invariant", "[Core.GeomOps]") {
...
TEST_CASE("Rotation acts on both Point and Direction members of a Ray", "[Core.GeomOps]") {
...
TEST_CASE("Box re-fits its axis-aligned bounds under rotation", "[Core.GeomOps]") {
...
TEST_CASE("Ball under rigid motion preserves its radius", "[Core.GeomOps]") {
    constexpr Sphere s =
...
TEST_CASE("Ball radius scale is exact under uniform scale", "[Core.GeomOps]") {
...
TEST_CASE("Ball radius bound stays conservative (encloses) under non-uniform scale", "[Core.GeomOps]") {
...
TEST_CASE("Plane normal uses the inverse-transpose law (orthogonality preserved under shear)", "[Core.GeomOps]") {
...
TEST_CASE("Plane incidence is preserved by an affine transform", "[Core.GeomOps]") {
...
TEST_CASE("Frustum planes shift their offset under translation", "[Core.GeomOps]") {
...
TEST_CASE("Affine composition equals sequential application", "[Core.GeomOps]") {
...
TEST_CASE("Transform concepts classify types correctly", "[Core.GeomOps]") {
